...
$GEM5_ROOT/build/X86/gem5.opt \
	...
	--checkpoint-dir=$GEM5_ROOT/checkpoint/docdist/singlecore \
	--dramsim2outputfile=/home/user/dagguise/checkpoint/docdist/singlecore/dram
