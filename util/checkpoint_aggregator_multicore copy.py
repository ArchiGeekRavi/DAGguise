    ...
    for (i, arg) in enumerate(cpts):
        ...
        for sec in config.sections():
            if re.compile("cpu").search(sec):
                # For three checkpoints, adjust CPU numbering
                print "sec: ", sec
                print "i: ", i
                print "num_digits: ", num_digits
                print "str(i).zfill(num_digits): ", str(i).zfill(num_digits)
                print "re.sub('cpu', 'cpu' + str(i).zfill(num_digits), sec): ", re.sub("cpu", "cpu" + str(i).zfill(num_digits), sec)
        ...
        # Memory handling for each checkpoint
