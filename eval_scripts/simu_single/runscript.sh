...
$GEM5_ROOT/build/X86/gem5.opt \
        --outdir=/home/user/dagguise/eval_scripts/simu_simple/results/docDist_2cpu_DAGguise/xz_r \
	...
	--benchmark=xz_r \
	--simpt-ckpt=0 \
	--dramsim2outputfile=/home/user/dagguise/eval_scripts/simu_simple/results/docDist_2cpu_DAGguise/xz_r/dram \
	> /home/user/dagguise/eval_scripts/simu_simple/results/docDist_2cpu_DAGguise/xz_r/runscript.log 2>&1 \
