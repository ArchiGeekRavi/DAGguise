...
OUTPUT_DIR=$GEM5_ROOT/eval_scripts/simu_simple/results/dna
...
$GEM5_ROOT/build/X86/gem5.opt \
    --outdir=/home/user/dagguise/eval_scripts/simu_simple/results/dna/xz_r \
	...
	--checkpoint-dir=$GEM5_ROOT/checkpoint_merge_dna/merged_checkpoint_dna/ \
	--benchmark=xz_r \
	--simpt-ckpt=0 \
	--dramsim2outputfile=/home/user/dagguise/eval_scripts/simu_simple/results/dna/xz_r/dram \
	>> $SCRIPT_OUT 2>&1
