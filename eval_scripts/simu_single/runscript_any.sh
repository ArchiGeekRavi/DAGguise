...
OUTPUT_DIR=$GEM5_ROOT/eval_scripts/simu_simple/mm
...
$GEM5_ROOT/build/X86/gem5.opt \
    --outdir=/home/user/dagguise/eval_scripts/simu_simple/mm \
	...
	-c "$SPEC_ROOT/benchspec/CPU/xz_r/run/run_base_refrate_gem5_se-m64.0000/xz_r" \
	--checkpoint-dir=/home/user/dagguise/checkpoint_merge_1/merged_checkpoint_1 \
	--benchmark=xz_r \
	--simpt-ckpt=0 \
	--dramsim2outputfile=/home/user/dagguise/eval_scripts/simu_simple/blender_r/dram \
	>> $SCRIPT_OUT 2>&1
