...
OUTPUT_DIR=$GEM5_ROOT/eval_scripts/simu_simple/results/multibank/
...
SCRIPT_OUT=$OUTPUT_DIR/runscript_multibank.log

cd $SPEC_ROOT/benchspec/CPU/xz_r/run/run_base_refrate_gem5_se-m64.0000/

$GEM5_ROOT/build/X86/gem5.opt \
    --outdir=/home/user/dagguise/eval_scripts/simu_simple/results/multibank/xz_r \
    ...
    --checkpoint-restore=1 --at-instruction --maxinsts=5000 --warmup-insts=5000 --standard-switch=5000 \
	...
	--benchmark=xz_r \
	--simpt-ckpt=0 \
	--dramsim2outputfile=/home/user/dagguise/eval_scripts/simu_simple/results/multibank/xz_r/dram \
	>> $SCRIPT_OUT 2>&1
