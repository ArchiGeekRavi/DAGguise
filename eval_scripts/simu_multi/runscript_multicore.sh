...
$GEM5_ROOT/build/X86/gem5.opt \
        --outdir=/home/user/dagguise/eval_scripts/simu_simple_multi/results/docDist_8cpu_FSBTA/xz_r \
	...
	--benchmark=xz_r \
	--checkpoint-dir=/home/user/dagguise/checkpoint_merge_multicore/merged_checkpoint_xz_r \
	--simpt-ckpt=0 \
	--dramsim2outputfile=/home/user/dagguise/eval_scripts/simu_simple_multi/results/docDist_8cpu_FSBTA/xz_r/dram \
	> /home/user/dagguise/eval_scripts/simu_simple_multi/results/docDist_8cpu_FSBTA/xz_r/runscript.log 2>&1 \
