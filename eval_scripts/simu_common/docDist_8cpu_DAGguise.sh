...
$GEM5_ROOT/build/X86/gem5.opt \
	...
	--mem-size=8GB --mem-channels=1 --mem-ranks=1 --enabledramlog \
        ...
        --dramsystemconfigfile=$GEM5_ROOT/ext/dramsim2/DRAMSim2/configs/system_dag_multi_8domain_closedrow.ini \
        --dagprotectionfile=";;;;$GEM5_ROOT/dag_generator/defense.json;$GEM5_ROOT/dag_generator/defense.json;$GEM5_ROOT/dag_generator/defense.json;$GEM5_ROOT/dag_generator/defense.json" \
