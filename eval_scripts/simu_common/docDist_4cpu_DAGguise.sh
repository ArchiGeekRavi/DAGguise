...
$GEM5_ROOT/build/X86/gem5.opt \
	...
	--mem-size=8GB --mem-channels=1 --mem-ranks=1 --enabledramlog \
        ...
        --dramsystemconfigfile=$GEM5_ROOT/ext/dramsim2/DRAMSim2/configs/system_dag_multi_4domain_closerow.ini \
        --dagprotectionfile=";;$GEM5_ROOT/dag_generator/defense.json;$GEM5_ROOT/dag_generator/defense.json" \
	-c "$GEM5_ROOT/sample_programs/docdist/docDist;$GEM5_ROOT/sample_programs/dna/src/mrsfast" \
    -o ";$GEM5_ROOT/sample_programs/dna/dataset/chr3_50K.fa --seq $GEM5_ROOT/sample_programs/dna/readSimulator/chr3_50K_2000.fq" \
